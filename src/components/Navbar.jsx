      ...
      <div className="container-wrapper">
        <div className="container flex items-center gap-2 h-14 md:gap-4">
          <div className="hidden mr-4 md:flex">
            <Link
              to="/"
              className="flex items-center gap-2 mr-4 lg:mr-6"
              href="/"
            >
              <svg
          ...
          <button className="md:hidden flex items-center gap-4 px-0 w-full h-8 text-base hover:bg-transparent">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
            ...
            <span className="flex items-center justify-between flex-1 h-8 px-2 text-sm font-normal border rounded-md bg-muted/50 text-muted-foreground">
              Search sections...
            </span>
          </button>
          <h2
          ...
          <div className="items-center gap-2 ml-auto md:flex-1 md:justify-end hidden md:flex">
            <div className="flex-1 hidden w-full md:flex md:w-auto md:flex-none">
              <button className="relative h-8 w-full justify-start rounded-lg bg-muted/50 text-sm font-normal text-muted-foreground shadow-none border hover:bg-accent hover:text-accent-foreground sm:pr-12 md:w-40 lg:w-56 xl:w-64 hidden md:flex items-center px-3 gap-2">
            ...
            <nav className="flex items-center gap-0.5">
              ...
              <button
                data-slot="button"
                className="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&amp;_svg]:pointer-events-none [&amp;_svg:not([className*='size-'])]:size-4 shrink-0 [&amp;_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive hover:bg-accent hover:text-accent-foreground dark:hover:bg-accent/50 py-2 has-[&gt;svg]:px-3 w-8 h-8 px-0 group/toggle"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
